              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo base_url('assets/assets_shop/')?>/assets/img/avatar/avatar-1.png" class="rounded-circle">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">APP VILLA</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">APV</a>
          </div>
          <ul class="sidebar-menu">
            
              <li><a class="nav-link" href="<?php echo base_url('admin/dashboard') ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('admin/hubungi_kami') ?>"><i class="fas fa-tachometer-alt"></i> <span>Pesan User</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('admin/data_villa') ?>"><i class="fas fa-home"></i> <span>Data Villa</span></a></li>
