...
class Data_type extends CI_Controller
{
	...
	public function tambah_type_aksi()
	{
		...
		if($this->form_validation->run() == FALSE ){
			...
			$this->villa_model->insert_data($data,'type');
			$this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
				  <strong>Data Type Berhasil Di Input ^_^</strong>.
	...
	public function update_type_aksi()
	{
		...
		if($this->form_validation->run() == FALSE)
		{
			...
			$this->villa_model->update_data('type',$data,$where);
			$this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
				  <strong>Data Type Berhasil Di Update ^_^</strong>.
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				    <span aria-hidden="true">&times;</span>
				  </button>
				</div>');
	...
	{
		$where = array('id_type' => $id);
		$this->villa_model->delete_data($where,'type');
		$this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert">
				  <strong>Data Type Berhasil Di Hapus ^_^</strong>.
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				    <span aria-hidden="true">&times;</span>
				  </button>
				</div>');
